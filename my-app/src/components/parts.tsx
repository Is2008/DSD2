...
const Parts = () => {
  return (
    <div id="parts">
        <Linktopart src={photo1} title="Die Wirkung von Umweltprotesten auf den Klimaschutz"></Linktopart>
        <Linktopart src={photo2} title="Einfluss von Protesten auf die Meinung der Macht "></Linktopart>
